...
pub fn main() !void {
    ...
    const solution = try switch (day) {
        ...
        8 => day8.solve(part, &file_reader.interface, &writer, 1000),
        9 => day9.solve(part, &file_reader.interface, &writer),
        10 => day10.solve(alloc, &file_reader.interface, &writer),
